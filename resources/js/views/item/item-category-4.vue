    ...
    <div>
        <div style="margin-bottom:40px;" class="nk-fmg-body-head d-none d-lg-flex">
            <div class="nk-fmg-search">
                ...
                <input type="text" class="form-control border-transparent form-focus-none" placeholder="Search Category 4">
            </div>
            <div class="nk-fmg-actions">
                <ul class="nk-block-tools g-3">
                    <li>
                        <a href="javascript:void(0)" @click="OPEN_MODAL('#modalCategory4');resetData()" class="btn btn-primary" data-toggle="modal">
                            <em class="icon ni ni-plus"></em> <span>New Item Category 4</span>
                        </a>
                    </li>
                </ul>
            </div>
                                ...
                                <table class="table table-tranx">
                                    ...
                                    <tbody>
                                        <tr v-for="(category, index) in categories" :key="category.uuid" class="tb-tnx-item">
                                            ...
                                            <td>
                                                <span class="">
                                                    <a href="javascript:void(0)"  @click="OPEN_MODAL('#modalCategory4');setData(category)" class="btn btn-sm btn-light"><em class="icon ni ni-pen2"></em></a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="item-category-4">Category 4</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.category4" type="text" class="form-control" id="category-4" required>
                                                    </div>
                                                </div>
                                            </div>
...
export default {
    ...
    methods: {
        ...
        save: function () {
            var scope = this
            scope.POST('items/category4/save', scope.formdata).then(res => {
                if (res.success) {
                    window.swal.fire({
                        position: 'center',
                        icon: 'success',
        ...
        update: function () {
            ...
            window.swal.fire({
                ...
                if (result.value) {
                    scope.PUT('items/category4/update', scope.formdata).then(res => {
                        if (res.success) {
                            window.swal.fire({
                                position: 'center',
                                icon: 'success',
