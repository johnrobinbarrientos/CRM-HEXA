<template>
    <div>
        ...
        <div class="actions-bar">
            <div class="w-100">
                <h1 class="title"><i class="las la-list-ul"></i>Global Customer Chain</h1>
            </div>
            <div class="bar-right">
            ...
            <div class="card-body">
                ...
                <div v-else class="table-responsive">
                    <table class="table table-striped table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(chain, index) in customerChains" :key="chain.uuid">
                                <td width="100">
                                    <span class="w-65px d-block mx-auto">
                                        <a href="javascript:void(0)"  @click="OPEN_MODAL('#modalCustomerChain');setData(chain)" class="btn btn-sm btn-shineblue" title="Edit"><i class="mdi mdi-pencil"></i></a>
                                        <a href="javascript:void(0)"  @click="remove(chain)" class="btn btn-sm btn-danger"><i class="mdi mdi-trash-can" title="Trash"></i></a>
                                    </span>
                                </td>
...
export default {
    ...
    methods: {
        getCustomerChains: function () {
            ...
            scope.GET('globals/customer-chain?keyword=' + scope.searchKeyword + '&page=' + scope.listCurrentPage + '&take=' + scope.listItemPerPage).then(res => {
