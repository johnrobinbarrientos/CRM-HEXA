<template>
    <div>
        ...
        <div class="actions-bar">
            <div class="w-100">
                <h1 class="title"><i class="las la-list-ul"></i>Global Customer Type</h1>
            </div>
            <div class="bar-right">
...
export default {
    ...
    methods: {
        getCustomerTypes: function () {
            ...
            scope.customerTypes = []
            scope.GET('globals/customer-type?keyword=' + scope.searchKeyword + '&page=' + scope.listCurrentPage + '&take=' + scope.listItemPerPage).then(res => {
