<template>
    <div>
        <div class="actions-bar">
            <div class="w-100">
                <h1 class="title"><i class="las la-list-ul"></i>Admin Cost Center</h1>
            </div>
            <div class="bar-right">
            ...
            <div class="row">
                <div class="col-lg-6">
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(costcenter) in costCenters" :key="costcenter.uuid">
                                <td width="100">
...
export default {
    ...
    methods: {
        getCostCenters: function () {
            ...
            scope.costCenters = []
            scope.GET('admin/cost-center?keyword=' + scope.searchKeyword + '&page=' + scope.listCurrentPage + '&take=' + scope.listItemPerPage).then(res => {
