...
export default {
    ...
    methods: {
        ...
        save: function () {
            var scope = this
            scope.POST('globals/address-list/save', scope.formdata).then(res => {
                if (res.success) {
                    window.swal.fire({
                        position: 'center',
                        icon: 'success',
                        ...
                        scope.addressList.push(res.data)
        ...
        update: function () {
            ...
            window.swal.fire({
                ...
                if (result.value) {
                    scope.PUT('globals/address-list/update', scope.formdata).then(res => {
                        if (res.success) {
                            window.swal.fire({
                                position: 'center',
                                icon: 'success',
