                            ...
                            <div class="card-inner card-inner-lg">
                                <div class="nk-block-head">
                                    <div class="nk-block-head-content">
                                        ...
                                        <div class="nk-block-des">
                                            <p>Access the HEXA panel using your email and passcode.</p>
                                        </div>
                                    </div>
                                </div>
                                <form v-on:submit.prevent="authenticate()">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input v-model="credentials.email" type="text" class="form-control form-control-lg" id="default-01" placeholder="Enter your email address or username">
                                    </div>
                                    <div class="form-group">
                                        <div class="form-label-group">
                                        ...
                                        <div class="form-control-wrap">
                                            ...
                                            <input v-model="credentials.password" type="password" class="form-control form-control-lg" id="password" placeholder="Enter your passcode">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="form-note-s2 text-center pt-4"> New on our platform? <a href="javascript:void(0);" @click="ROUTE('register')">Create an account</a>
                                </div>
