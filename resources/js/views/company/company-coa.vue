    ...
    <div>
        <div style="margin-bottom:40px;" class="nk-fmg-body-head d-none d-lg-flex">
            <div class="nk-fmg-search">
                ...
                <input type="text" class="form-control border-transparent form-focus-none" placeholder="Search Chart of Account">
            </div>
            <div class="nk-fmg-actions">
                <ul class="nk-block-tools g-3">
                    ...
                    <li>
                        <a href="javascript:void(0)" @click="OPEN_MODAL('#modalLocation');resetData()" class="btn btn-primary" data-toggle="modal">
                            <em class="icon ni ni-plus"></em> <span>New COA Group</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" @click="OPEN_MODAL('#modalLocation');resetData()" class="btn btn-primary" data-toggle="modal">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="coa-code">Code</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formCoa.coa_code" type="text" class="form-control" id="code" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="coa-account">Account</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formCoa.coa_account" type="text" class="form-control" id="account" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="coa-group">Group</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formCoa.coa_group" type="text" class="form-control" id="group" required>
                                                    </div>
                                                </div>
                                            </div>
