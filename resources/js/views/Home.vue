<template>
    <div>
        <div style="margin-bottom:30px; display:none;" class="nk-fmg-body-head d-none d-lg-flex">
        ...
        <div style="display:none;" class="nk-content nk-content-fluid">          
                                ...
                                <div class="modal-body">
                                    <form action="#" class="form-validate is-alter">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <select v-model="formdata.company_id" class="select-companies" name="state"> </select>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer bg-light">
                                    <button @click="save()" type="submit" class="btn btn-lg btn-primary">Save</button>
                                </div>
                            </div>
                        </div>
                    </div>
