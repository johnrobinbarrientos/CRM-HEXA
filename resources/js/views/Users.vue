    ...
    <div>
       ...
       <div class="kx-content-wrapper">
            ...
            <div style="display:flex; justify-content: space-between; padding:10px 25px;">
                <div><h2 style="margin:0px;">Users</h2></div>
                <div><button @click="toggleForm()" class="kx-btn-rounded kx-btn kx-btn-orange ">Add User</button></div>
            </div>
            <div class="kx-content">
                <div v-if="show_form" class="kx-panel">
                    <div class="kx-panel-header">NEW USER</div>
                    <div class="kx-panel-content">
                        <div class="kx-form-group">
                            <input placeholder="Email Address" v-model="data.email" type="email">
                        </div>
                        <div class="kx-form-group">
                            <input placeholder="First Name" v-model="data.firstname" type="text">
                        </div>
                        <div class="kx-form-group">
                            <input placeholder="Last Name" v-model="data.lastname" type="text">
                        </div>
                        <div class="kx-form-group">
                            <input placeholder="Password" v-model="data.password" type="password">
                        </div>
                    </div>
