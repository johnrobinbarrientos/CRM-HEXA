    ...
    <div>
        <div class="actions-bar">
            ...
            <div class="bar-right">
                ...
                <a href="javascript:void(0)" @click="OPEN_MODAL('#modalReasonCodesBilling');resetData()" class="hx-btn hx-btn-shineblue" data-toggle="modal">
                                ...
                                <tr v-for="(codes) in reasonCodes" :key="codes.uuid">
                                    <td width="65" class="text-center">
                                        <span class="hx-table-actions">
                                            <b-dropdown split text="Edit" size ="sm" class="m-2" href="javascript:void(0)" @click="OPEN_MODAL('#modalReasonCodesBilling');setData(codes)">
                                                <b-dropdown-item href="javascript:void(0)" @click="OPEN_MODAL('#modalReasonCodesBilling');setData(codes)">Edit</b-dropdown-item>
        ...
        <!-- Modal Group Form -->
        <div class="modal fade modal-single-form" tabindex="-1" id="modalReasonCodesBilling">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Reason Code</h5>
                        <a href="javascript:void(0)"  @click="CLOSE_MODAL('#modalReasonCodesBilling');" class="close" data-dismiss="modal" aria-label="Close">
                            <i class="bx bx-x"></i>
                        </a>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="bill-reason-code-short-name">Short Name:</label>
                                        <div class="form-control-wrap">
                                            <input style="text-transform: uppercase;" v-model="formdata.short_name" type="text" class="form-control" id="bill-reason-code-short-name" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="bill-reason-code-details">Details:</label>
                                        <div class="form-control-wrap">
                                            <input v-model="formdata.details" type="text" class="form-control" id="bill-reason-code-details" required>
                                        </div>
                                    </div>
                                </div>
            ...
            scope.POST('reason-codes', scope.formdata).then(res => {
                if (res.success) {
                    window.swal.fire({
                        ...
                        scope.CLOSE_MODAL('#modalReasonCodesBilling')
                    })
                } else {
