            ...
            <div v-else class="table-responsive;">
                <div style="background:#f9f9f9; border:1px solid #d7d8e0; padding:0px; margin-bottom: 5px;">
                    <div style="display:flex; justify-content: flex-start;">
                        ...
                        <div style="background:#e5e5ed; padding:3px 8px; border-right:1px solid #d7d8e0;">
                            <select  @change="getBilledOrders()" v-model="selected_supplier" style="padding:5px; background:transparent; border:none; width:100%;">
                                <option value="">Supplier</option>
                                <option v-for="supplier in options_supplier" :value="supplier.id"  :key="'option-' + supplier.id ">{{ supplier.text }}</option>
                            </select>
                        </div>
                        <div style="background:#e5e5ed; padding:3px 8px; border-right:1px solid #d7d8e0;">
                            <select  @change="getBilledOrders()" v-model="selected_branch" style="padding:5px; background:transparent; border:none; width:100%;">
                                <option value="">Branch</option>
                                <option v-for="branch in options_branch" :value="branch.id"  :key="'option-' + branch.id ">{{ branch.text }}</option>
                            </select>
                        </div>
                        <div style="background:#e5e5ed; padding:3px 8px; border-right:1px solid #d7d8e0;">
                            <select  @change="getBilledOrders()" v-model="selected_branch_location" style="padding:5px; background:transparent; border:none; width:100%;">
                                <option value="">Location</option>
                                <option v-for="location in options_branch_location" :value="location.id"  :key="'option-' + location.id ">{{ location.text }}</option>
                            </select>
                        </div>
                        <div style="background:#e5e5ed; padding:3px 8px; border-right:1px solid #d7d8e0;">
                            <select  @change="getBilledOrders()" v-model="selected_status" style="padding:5px; background:transparent; border:none; width:100%;">
                        ...
                        <div style="background:#e5e5ed; padding:3px 8px; border-right:1px solid #d7d8e0;">
                            <select  @change="getBilledOrders()" v-model="selected_reason_code_filter" style="padding:5px; background:transparent; border:none; width:100%;">
    ...
    methods: {
        ...
        getBilledOrders: function () {
           var scope = this
            ...
            scope.GET('buy-and-pay/billed?keyword=' + scope.searchKeyword + '&page=' + scope.listCurrentPage + '&take=' + scope.listItemPerPage + '&' + str).then(res => {
