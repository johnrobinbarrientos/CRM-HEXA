                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="item-category-5">Category 5</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.category5" type="text" class="form-control" id="category-5" required>
                                                    </div>
                                                </div>
                                            </div>
...
export default {
    ...
    methods: {
        ...
        save: function () {
            var scope = this
            scope.POST('items/category5/save', scope.formdata).then(res => {
                if (res.success) {
                    window.swal.fire({
                        position: 'center',
                        icon: 'success',
        ...
        update: function () {
            ...
            window.swal.fire({
                ...
                if (result.value) {
                    scope.PUT('items/category5/update', scope.formdata).then(res => {
                        if (res.success) {
                            window.swal.fire({
                                position: 'center',
                                icon: 'success',
