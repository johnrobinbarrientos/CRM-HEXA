    ...
    <div>
        ...
        <div v-else class="table-responsive"> 
            <table class="table table-bordered table-hover table-striped">
                ...
                <tbody>
                    <tr v-for="(price_rule) in priceRules" :key="price_rule.uuid" class="tb-tnx-price-rule">
                        <td width="65" class="text-center">
                            <span class="hx-table-actions">
                                <b-dropdown split text="Edit" size ="sm" class="m-2" href="javascript:void(0)" @click="ROUTE({path: '/price-rule/' +  price_rule.uuid });">
                                    <b-dropdown-item href="javascript:void(0)" @click="ROUTE({path: '/price-rule/' +  price_rule.uuid });">Edit</b-dropdown-item>
...
export default {
    ...
    methods: {
        getPriceRules: function () {
           var scope = this
             scope.GET('price-rules?keyword=' + scope.searchKeyword + '&page=' + scope.listCurrentPage + '&take=' + scope.listItemPerPage).then(res => {
