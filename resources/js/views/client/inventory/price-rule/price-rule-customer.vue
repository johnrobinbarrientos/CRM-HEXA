                ...
                <ul v-show ="formdata.uuid" class="nav nav-tabs">    
                    ...
                    <div class="tab-content">    
                        ...
                        <div class="tab-pane active" id="supplier">
                            <price-rule-customer-details v-if="formdata.uuid" :properties="formdata.uuid"></price-rule-customer-details>
                        </div>
...
import PriceRuleCustomerDetails from './price-rule-customer-details'

import Swal from 'sweetalert2'
import moment from 'moment'

export default {
    name: 'price-rule-customer',
    props: ['properties'],

    components: {
        'price-rule-customer-details': PriceRuleCustomerDetails,
    },
