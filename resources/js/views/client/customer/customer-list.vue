                ...
                <ul class="nk-block-tools g-3">
                    <li>
                        <a href="javascript:void(0)" @click="OPEN_MODAL('#modalLocation');resetData()" class="btn btn-primary" data-toggle="modal">
                            <em class="icon ni ni-plus"></em> <span>New Group</span>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)" @click="OPEN_MODAL('#modalLocation');resetData()" class="btn btn-primary" data-toggle="modal">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="business-name">Sold To Name</label>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="business-shortname">Business Group Name</label>
                                                    <div class="form-control-wrap">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="check-payee">Shortname</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.location_name" type="text" class="form-control" id="location-name" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="check-payee">TIN</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.location_name" type="text" class="form-control" id="location-name" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="check-payee">Chain</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.location_name" type="text" class="form-control" id="location-name" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="check-payee">Channel</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.location_name" type="text" class="form-control" id="location-name" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="check-payee">Customer Type</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.location_name" type="text" class="form-control" id="location-name" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="check-payee">VAT Name</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.location_name" type="text" class="form-control" id="location-name" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="check-payee">Term</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.location_name" type="text" class="form-control" id="location-name" required>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="form-group">
                                                    <label class="form-label" for="check-payee">Default Account Receivable</label>
                                                    <div class="form-control-wrap">
                                                        <input v-model="formdata.location_name" type="text" class="form-control" id="location-name" required>
                                                    </div>
                                                </div>
