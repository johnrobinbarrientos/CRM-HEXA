                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="so-reason-code-short-name">Short Name:</label>
                                        <div class="form-control-wrap">
                                            <input style="text-transform: uppercase;" v-model="formdata.short_name" type="text" class="form-control" id="so-reason-code-short-name" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="so-reason-code-details">Details:</label>
                                        <div class="form-control-wrap">
                                            <input v-model="formdata.details" type="text" class="form-control" id="so-reason-code-details" required>
                                        </div>
                                    </div>
                                </div>
...
export default {
    ...
    methods: {
        getReasonCodes: function () {
            ...
            scope.reasonCodes = []
            scope.GET('reason-codes/?type=sales-order&keyword=' + scope.searchKeyword + '&page=' + scope.listCurrentPage + '&take=' + scope.listItemPerPage).then(res => {
        ...
        resetData: function () {
            ...
            scope.formdata.type = 'Sales Order'
        },
