        ...
        <div class="actions-bar">
            <div class="w-100">
                <h1 class="title">
                    ...
                    <span @click="ROUTE({path: '/project-main/' })">Project List</span>
                </h1>
            </div>
            <div class="bar-right">
                ...
                <a @click="ROUTE({path: '/projects/create'})" class="hx-btn hx-btn-shineblue" data-toggle="modal" href="javascript:void(0)">
