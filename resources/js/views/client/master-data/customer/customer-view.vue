                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.sold_to_name" type="text" class="form-control" id="sold-to-name" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.business_group_name" type="text" class="form-control" id="business-group-name" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.business_shortname" type="text" class="form-control" id="business-shortname" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.tax_id_no" type="text" class="form-control" id="tax_id" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.contact_person" type="text" class="form-control" id="contact-person" readonly>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4 col-12">
                                <div class="form-group">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" v-model="formdata.is_applied_vat" true-value="1" false-value="0" class="custom-control-input" id="is-applied-vat" disabled>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" v-model="is_vat" value="1" class="custom-control-input" id="is-vat" disabled>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input v-model="customerDiscountFormData.discount_name" type="text" class="form-control" id="discount-name" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <input v-model="customerDiscountFormData.discount_rate" type="text" class="form-control" id="discount-rate" readonly>
                                                </div>
                                            </div>
                                        </div>
...
export default {
    ...
    mounted() {
        ...
        var customerUUID = scope.properties.uuid
