                ...
                <div id="collapseNine" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                    <div class="card-body">
                        ...
                        <div class="container-fluid">
                                        ...
                                        <tr v-for="(category, index) in categories" :key="category.uuid">
                                            <td width="100">
                                                <span class="w-65px d-block mx-auto">
                                                    <a href="javascript:void(0)" @click="OPEN_MODAL('#modalSizes');setData(category)" class="btn btn-sm btn-shineblue "><i class="mdi mdi-pencil"></i></a>
                            ...
                            <div class="modal fade" tabindex="-1" id="modalSizes">
