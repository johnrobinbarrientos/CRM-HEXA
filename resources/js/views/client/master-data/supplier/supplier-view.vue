                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.business_name" type="text" class="form-control" id="business-name" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.check_payee" type="text" class="form-control" id="check-payee" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            <div class="form-control-wrap">
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" v-model="formdata.is_transporter" true-value="1" false-value="0" class="custom-control-input" id="is-transporter" disabled="true">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.lead_time" type="text" class="form-control" id="lead-time" readonly>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-12">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                <input v-model="formdata.tax_identification_no" type="text" class="form-control" id="tax-identification-no" readonly>
                            </div>
                        </div>
                    </div>
                ...
                <ul class="nav nav-tabs">    
                    ...
                    <div class="tab-content">    
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" v-model="with_vat" class="custom-control-input" id="with-vat" disabled="true">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" v-model="with_ewt" value="1" class="custom-control-input" id="with-ewt" disabled="true">
                        ...
                        <div class="tab-pane" id="discounts">
                            <SupplierDiscounts v-if="formdata.uuid" :supplier_uuid="formdata.uuid" :properties="{view:true}" ></SupplierDiscounts>
                        </div>
...
export default {
    ...
    mounted() {
        ...
        var supplierUUID = scope.properties.uuid
