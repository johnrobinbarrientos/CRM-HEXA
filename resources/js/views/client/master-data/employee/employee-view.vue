<template>
    <div>
        ...
        <div class="bar-right" style="text-align-last: right;">
            <a @click="create()" class="btn btn-md btn-danger waves-effect" data-toggle="modal" href="javascript:void(0)">
                Delete
            </a>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.emp_id" type="text" class="form-control" id="employee-id" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.first_name" type="text" class="form-control" id="first-name" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.middle_name" type="text" class="form-control" id="middle-name" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.last_name" type="text" class="form-control" id="last-name" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.ext" type="text" class="form-control" id="ext" readonly>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" v-model="formdata.is_custodian" true-value="1" false-value="0" class="custom-control-input" id="is-custodian" disabled>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" v-model="formdata.is_driver " true-value="1" false-value="0" class="custom-control-input" id="is-driver" disabled>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" v-model="formdata.is_system_user" true-value="1" false-value="0" class="custom-control-input" id="is-system-user" disabled>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        <div class="form-control-wrap">
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" v-model="formdata.is_active" true-value="1" false-value="0" class="custom-control-input" id="is-active" disabled>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.email" type="text" class="form-control" id="email" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.contact_no " type="text" class="form-control" id="contact-no" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.emergeny_contact" type="text" class="form-control" id="emergency-contact" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.emergeny_contact_relation" type="text" class="form-control" id="contact-relation" readonly>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6 col-12">
                    <div class="form-group">
                        ...
                        <div class="form-control-wrap">
                            <input v-model="formdata.relation_contact_no" type="text" class="form-control" id="relation-contact-no" readonly>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="tab-pane active" id="employement">
                        ...
                        <div class="col-md-3 col-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <date-picker v-model="formdata.date_hired" :config="{format: 'YYYY-MM-DD'}" disabled></date-picker>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <date-picker v-model="formdata.date_regularized" :config="{format: 'YYYY-MM-DD'}" disabled></date-picker>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3 col-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <date-picker v-model="formdata.date_terminated" :config="{format: 'YYYY-MM-DD'}" disabled></date-picker>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" v-model="formdata.is_min_wage" true-value="1" false-value="0" class="custom-control-input" id="is-min-wage" disabled>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input v-model="formdata.daily_wage" type="text" class="form-control" id="daily-wage" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    <div class="form-control-wrap">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" v-model="formdata.is_applied_tax" true-value="1" false-value="0" class="custom-control-input" id="is-applied-tax" disabled>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input v-model="formdata.tax_id" type="text" class="form-control" id="tax-id" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input v-model="formdata.sss_id" type="text" class="form-control" id="sss-id" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input v-model="formdata.phic_id" type="text" class="form-control" id="phic-id" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                        <input v-model="formdata.hdmf_id" type="text" class="form-control" id="hdmf-id" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>    
                    ...
                    <div class="tab-pane" id="address"> 
                        ...
                        <div class="col-md-3 col-12">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input v-model="formdata.address1" type="text" class="form-control" id="address1" readonly>
                                </div>
                            </div>
                        </div>
...
export default {
    ...
    mounted() {
        ...
        var employeeUUID = scope.properties.uuid
