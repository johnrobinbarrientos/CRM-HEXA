    ...
    <div>
        <div class="actions-bar">
            ...
            <div class="bar-right">
                ...
                <a href="javascript:void(0)" @click="OPEN_MODAL('#modalBranch');resetData()" class="hx-btn hx-btn-shineblue" data-toggle="modal">
        ...
        <!-- Modal Group Form -->
        <div class="modal fade modal-single-form" tabindex="-1" id="modalBranch">
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="branch-name">Name:</label>
