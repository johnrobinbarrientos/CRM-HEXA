    ...
    <div>
        <div class="actions-bar">
            ...
            <div class="bar-right">
                ...
                <a href="javascript:void(0)" @click="OPEN_MODAL('#modalTaxationItem');resetData()" class="hx-btn hx-btn-shineblue" data-toggle="modal">
                        ...
                        <tr v-for="(tax) in Taxations" :key="tax.uuid">
                            <td width="100">
                                <span class="hx-table-actions">
                                    <b-dropdown split text="Edit" size ="sm" class="m-2" href="javascript:void(0)" @click="OPEN_MODAL('#modalTaxationItem');setData(tax)">
                                        <b-dropdown-item href="javascript:void(0)" @click="OPEN_MODAL('#modalTaxationItem');setData(tax)">Edit</b-dropdown-item>
        ...
        <!-- Modal Group Form -->
        <div class="modal fade modal-single-form" tabindex="-1" id="modalTaxationItem">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Taxation</h5>
                        <a href="javascript:void(0)"  @click="CLOSE_MODAL('#modalTaxationItem');" class="close" data-dismiss="modal" aria-label="Close">
                            <i class="bx bx-x"></i>
                        </a>
                    </div>
                    <div class="modal-body">
                        <form action="#" class="form-validate is-alter">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 col-12">
                                    <div class="form-group">
                                        <label class="form-label" for="tax-shortname">Shortname:</label>
                                        <div class="form-control-wrap">
                                            <input v-model="formdata.shortname" type="text" class="form-control" id="tax-shortname" required>
                                        </div>
                                    </div>
                                </div>
