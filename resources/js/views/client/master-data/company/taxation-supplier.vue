<template>
    <div>
        <div class="actions-bar">
            <div class="w-100">
                <h1 class="title"><i class="las la-list-ul"></i>Taxation Table</h1>
            </div>
            <div class="bar-right">
                ...
                <a href="javascript:void(0)" @click="OPEN_MODAL('#modalTaxationSupplier');resetData()" class="hx-btn hx-btn-shineblue" data-toggle="modal">
                        ...
                        <tr v-for="(tax) in Taxations" :key="tax.uuid">
                            <td width="100">
                                <span class="hx-table-actions">
                                    <b-dropdown split text="Edit" size ="sm" class="m-2" href="javascript:void(0)" @click="OPEN_MODAL('#modalTaxationSupplier');setData(tax)">
                                        <b-dropdown-item href="javascript:void(0)" @click="OPEN_MODAL('#modalTaxationSupplier');setData(tax)">Edit</b-dropdown-item>
        ...
        <!-- Modal Group Form -->
        <div class="modal fade modal-single-form" tabindex="-1" id="modalTaxationSupplier">
            <div class="modal-dialog modal-md" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Taxation</h5>
                        <a href="javascript:void(0)"  @click="CLOSE_MODAL('#modalTaxationSupplier');" class="close" data-dismiss="modal" aria-label="Close">
                            <i class="bx bx-x"></i>
                        </a>
                    </div>
...
export default {
    ...
    methods: {
        getTaxation: function () {
            ...
            scope.Taxations = []
            scope.GET('company/taxation-is-supplier?keyword=' + scope.searchKeyword + '&page=' + scope.listCurrentPage + '&take=' + scope.listItemPerPage).then(res => {
            ...
            scope.POST('company/taxation', scope.formdata).then(res => {
                if (res.success) {
                    window.swal.fire({
                        ...
                        scope.getTaxation()
                        scope.CLOSE_MODAL('#modalTaxationSupplier')
                    })
                } else {
